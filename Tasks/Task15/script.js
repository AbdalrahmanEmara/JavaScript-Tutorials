...
console.log('Two');
// Method One (Object Literals)
const objMethodOne = {
  property: 'Method One',
};
console.log(objMethodOne.property); // "Method One"

// Method Two (using a constructor)
function objectConstructor (property) {
  this.property = property;
}

const objMethodTwo = new objectConstructor('Method Two');
console.log(objMethodTwo.property); // "Method Two"

// Method Three
const objMethodThree = Object.create(objMethodOne);
objMethodThree.property = "Method Three";
console.log(objMethodThree.property); // "Method Three"

// Method Four (using es6 classes)
class objectClass {
...
const objMethodFour = new objectClass("Method Four");
